...
| 2026-03-25 | Codex | Lowered the About page timeline further in /css/about-redesign.css so the first milestone row aligns with the main story headline rather than the `Our Story` label, and increased spacing before the story body copy |
